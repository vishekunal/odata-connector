...
import org.mule.odata4j.stax2.Attribute2;
import org.mule.odata4j.stax2.QName2;
import org.mule.odata4j.stax2.StartElement2;
import org.mule.odata4j.stax2.XMLEvent2;
import org.mule.odata4j.core.ODataVersion;
import org.mule.odata4j.core.OPredicates;
import org.mule.odata4j.edm.EdmAssociation;
import org.mule.odata4j.edm.EdmAssociationEnd;
import org.mule.odata4j.edm.EdmAssociationSet;
import org.mule.odata4j.edm.EdmAssociationSetEnd;
...
import org.mule.odata4j.edm.EdmEntityContainer;
...
import org.mule.odata4j.edm.EdmFunctionParameter;
...
public class EdmxFormatParser extends XmlFormatParser {
  ...
  public EdmDataServices parseMetadata(XMLEventReader2 reader) {
    ...
    while (reader.hasNext()) {
      ...
      if (isStartElement(event, EDMX_EDMX)) {
    ...
    while (reader.hasNext()) {
      ...
      if (isStartElement(event, EDM2006_PARAMETER, EDM2007_PARAMETER, EDM2008_PARAMETER, EDM2009_PARAMETER)) {
        ...
        parameters.add(EdmFunctionParameter.newBuilder()
            ...
            .setMode(modeAttribute != null ? EdmFunctionParameter.Mode.valueOf(modeAttribute.getValue()) : null));
      }
