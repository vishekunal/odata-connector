...
package org.mule.odata4j.producer.edm;
...
import org.mule.odata4j.core.NamespacedAnnotation;
...
import org.mule.odata4j.edm.EdmAnnotationAttribute;
...
import org.mule.odata4j.edm.EdmDecorator;
...
import org.mule.odata4j.edm.EdmItem;
...
import org.mule.odata4j.producer.ExpressionEvaluator;
import org.mule.odata4j.producer.ExpressionEvaluator.VariableResolver;
import org.mule.odata4j.producer.ODataProducer;
import org.mule.odata4j.producer.PropertyPath;
import org.mule.odata4j.producer.PropertyPathHelper;
          ...
          if (c.pathHelper.isSelected(propName)) {
            ...
            if (override != MetadataProducer.REMOVE_ANNOTATION_OVERRIDE) {
              ...
              if (a instanceof EdmAnnotationAttribute) {
                ...
                props.add(OProperties.collection(propName, new EdmCollectionType(EdmProperty.CollectionKind.Bag, co.getType()), co));
              }
            }
          }
        }
