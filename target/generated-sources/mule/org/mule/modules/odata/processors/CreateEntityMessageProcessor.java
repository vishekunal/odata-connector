...
/**
 * CreateEntityMessageProcessor invokes the {@link org.mule.modules.odata.ODataConnector#createEntity(org.mule.api.MuleMessage, java.lang.Object, java.lang.String)} method in {@link ODataConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final Object _transformedEntity = ((Object) evaluateAndTransform(getMuleContext(), event, CreateEntityMessageProcessor.class.getDeclaredField("_entityType").getGenericType(), null, entity));
            final String _transformedEntitySetName = ((String) evaluateAndTransform(getMuleContext(), event, CreateEntityMessageProcessor.class.getDeclaredField("_entitySetNameType").getGenericType(), null, entitySetName));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((ODataConnector) object).createEntity(event.getMessage(), _transformedEntity, _transformedEntitySetName);
                    return null;
                }
